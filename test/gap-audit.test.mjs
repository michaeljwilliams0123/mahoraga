...
const CONTRACT_IDS = [
  ...
  "credit-free-heartbeat", "credit-free-heartbeat-ledger", "unattended-cycle-memory",
...
const FILE_BACKED_IDS = [
  ...
  "local-provider-readiness-probe", "local-reasoner-health-contract", "credit-free-heartbeat", "credit-free-heartbeat-ledger", "unattended-cycle-memory", "owner-approved-cloud-gateway", "verified-attested-update-channel",
];

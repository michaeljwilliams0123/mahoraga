...
test("heartbeat receipts require exact zero-paid semantics and canonical timestamps", () => {
...
test("compounded learning derives latest timestamps chronologically, not from input order", () => {

...
const planReport = normalizeStewardFoundryReport(JSON.parse(readFileSync(plansPath, 'utf8')));
...
process.stdout.write(`${JSON.stringify({ schemaVersion: 1, createdCount: createdAgentIds.length, createdAgentIds, nextAction: planReport.nextAction, zeroCredit: true, creditCost: 0, paidFallback: false })}\n`);

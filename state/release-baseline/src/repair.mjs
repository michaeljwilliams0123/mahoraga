...
export const ESSENTIAL_FILES = [
  ...
  "src/config.mjs",
  "src/product-identity.mjs",
  "src/config-legacy.mjs",
  "src/local-auth.mjs",
  "src/local-artifact-store.mjs",
  "src/omnichannel-intake.mjs",
  "src/universal-artifact-ingestion.mjs",
  ...
  "config/model-supply-chain.json",
  "config/destiny-trigger-trust.json",
  "config/product-identity.json",
  "state/incumbent-trust-epoch.json",
  "src/microsoft365-worker.mjs",
  "src/google-capability-manifest.mjs",
  "src/google-workspace-worker.mjs",
  "src/signed-chrome-worker.mjs",
  ...
  "src/platform-lifecycle.mjs",
  "config/platform-lifecycle.json",

export async function executeBrowserCapability(capability) {
  ...
  return {
    verified: true,
    summary: "Local browser execution is retired. Interactive browsing is available only through the approval-gated isolated cloud browser in the canonical Railway workspace.",

...
- **Target framework (browser UI):** Next.js in `cloud-app/`, exported to **GitHub Pages** for production.
...
- **App host:** GitHub Pages from approved `main`. Google Workspace is identity, mail, and docs — not the app host.

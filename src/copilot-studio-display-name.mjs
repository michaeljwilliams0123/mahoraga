...
const TARGETS = Object.freeze([
  Object.freeze({
    ...
    botId: "501917a0-9e8e-f111-8076-000d3a30cfe7",
    legacyName: "Mahorago Enterprise Core",
    targetName: "Mahoraga Enterprise Core",
  }),
  Object.freeze({
    alias: "tenant-health-reader",
    botId: "3fed8376-1c8e-f111-8076-000d3a30cfe7",
    legacyName: "Mahorago Tenant Health Reader",
    targetName: "Mahoraga Tenant Health Reader",
  }),
]);
...
function getArgs(botId) {
  return ["data", "get", "--table", TABLE, "--id", botId, "--select", SELECT, "--json"];
}
function updateArgs(botId, payload) {
  return ["data", "update", "--table", TABLE, "--id", botId, "--data", payload, "--return", "--json"];
}

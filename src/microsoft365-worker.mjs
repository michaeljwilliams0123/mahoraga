...
async function probePacAuthentication(dependencies = {}) {
  const requestedExecutable = typeof dependencies.pacExecutable === "string" ? dependencies.pacExecutable : "";
  const executable = requestedExecutable === "pac.cmd" ? requestedExecutable : "pac.cmd";

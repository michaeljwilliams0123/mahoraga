...
export function coordinationPayload(manifest, database) {
  ...
  return {
    ...
    authority: {
      model: "peer-authorized-bidirectional",
      primary: "main-codex",
      secondary: "secondary-codex",
      rolesAreTransportOnly: true,
      authorizedControllers: ["main-codex", "secondary-codex"],
      primaryIntegrationAuthority: true,
      secondaryCanCreateAssignments: true,
      secondaryCanMerge: true,
      eitherControllerMayAssign: true,
      eitherControllerMayImplement: true,
      eitherControllerMayReview: true,
      eitherControllerMayMergeAfterVerification: true,

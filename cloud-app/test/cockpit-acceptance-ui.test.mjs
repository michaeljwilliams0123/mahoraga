...
describe("7.0.0-alpha.2 cockpit Cloudflare acceptance evidence", () => {
  ...
  it("surfaces Billing Read token observationally without secrets or traffic authority", () => {
    assert.match(cockpit, /Billing Read token/);
    ...
    assert.match(cockpit, /No secret values stored/);

  ...
  return (
    <section className="connection-panel eclipse-console" aria-label="Control Center">
      ...
      <div className="eclipse-status-grid">
        ...
        <StatusCard label="GLM attestation canary" value="Parser repaired (observational)" detail="READY canary accepts choices[].message.content and legacy response; reasoning disabled; max_completion_tokens only. Parser 502 after env.AI.run is not traffic authority. 9,000/10,000 neuron hard-zero budget unchanged. Merge #773 is not live cognition or traffic authority." tone="neutral" />
      ...
      <div className="eclipse-detail-grid">
        <section className="eclipse-panel" aria-labelledby="telemetry-heading">
          ...
          <dl className="eclipse-metrics">
            ...
            <div><dt>GLM attestation canary</dt><dd>choices[].message.content + legacy response · READY-only no-reasoning · not traffic authority · #773 observational</dd></div>

  ...
  return (
    <section className="connection-panel eclipse-console" aria-label="Control Center">
      ...
      <p className="eclipse-readiness-note" role="status">
        Cloudflare candidate browser: {CLOUDFLARE_WORKSPACE_CANDIDATE} · promotion unverified-cloudflare-static. Owner-only workflow_dispatch on the existing workspace-candidate workflow republishes the exact current main SHA (matches execution-runtime lane; qualifying workflow_run path preserved; #800). Still unverified-cloudflare-static until health.json commit provenance and current-head Cloudflare acceptance are observed. GitHub Pages remains a presentation/export fallback. /api/ready is observational execution/durable-state evidence only and never grants traffic/domain authority.
      </p>
      ...
      <div className="eclipse-status-grid">
        ...
        <StatusCard label="Candidate republish" value="Exact-main SHA dispatch #800" detail="Owner-only workflow_dispatch on existing Cloudflare workspace candidate workflow; exact current main SHA matching execution-runtime. Qualifying workflow_run preserved. Still unverified-cloudflare-static until health.json commit provenance and current-head Cloudflare acceptance are observed. No traffic-authority claim." tone="neutral" />
      ...
      <div className="eclipse-detail-grid">
        <section className="eclipse-panel" aria-labelledby="telemetry-heading">
          ...
          <dl className="eclipse-metrics">
            ...
            <div><dt>Candidate republish</dt><dd>exact-main SHA workflow_dispatch (#800) · owner-only · same execution-runtime SHA · workflow_run preserved · unverified until health.json provenance + current-head Cloudflare acceptance</dd></div>

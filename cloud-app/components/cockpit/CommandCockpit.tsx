      ...
      <div className="cockpit-main">
        <header className="cockpit-header">
          ...
          <div className="cockpit-header-meta">
            ...
            <span className="cockpit-pill steel">BILLING_READ_OBS</span>
          </div>
        </header>
        ...
        <aside className="cockpit-panel tone-ok" aria-label="Convergence status">
          ...
          <p role="status">
            Observational only: optional CLOUDFLARE_BILLING_READ_TOKEN is used for Cloudflare subscriptions read on cutover and hourly renewal. A 403 reports cloudflare-subscriptions-billing-read-required-403 and admission fails closed. Operator action: same-account token with Account → Billing → Read. Credential values are never shown, stored, or logged here. This is not traffic authority and does not claim Cloudflare promotion.
          </p>
          <dl>
        ...
        <aside className="cockpit-panel tone-neutral" aria-label="Edge convergence truth planes">
          ...
          <dl>
            ...
            <div><dt>Billing Read token</dt><dd>optional CLOUDFLARE_BILLING_READ_TOKEN · cutover + hourly renewal subscriptions read only · cloudflare-subscriptions-billing-read-required-403 fail-closed · same-account Account → Billing → Read · secret values never shown</dd></div>

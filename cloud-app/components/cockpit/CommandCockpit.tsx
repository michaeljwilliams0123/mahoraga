...
function panelFromHealth(id: CockpitPanelId, health: ObservationalHealthCard | null, coreReady: boolean): CockpitPanelModel {
  ...
  if (id === "cloud") {
    return {
      ...
      lines: [
        ...
        { label: "candidateRepublish", value: "exact-main SHA workflow_dispatch (#800); unverified-cloudflare-static until health.json + current-head acceptance" },
      ],
      actionable: false,
    };
  }
  return {
    ...
    lines: [
      ...
      { label: "candidateRepublish", value: "exact-main SHA owner-only workflow_dispatch (#800); workflow_run preserved" },
    ...
    <div className="cockpit-root">
      <div className="cockpit-main">
        ...
        <aside className="cockpit-panel tone-ok" aria-label="Convergence status">
          ...
          <p role="status">
            Cloudflare candidate browser: {CLOUDFLARE_WORKSPACE_CANDIDATE} · promotion unverified-cloudflare-static. Owner-only workflow_dispatch on the existing workspace-candidate workflow republishes the exact current main SHA (matches execution-runtime lane; qualifying workflow_run path preserved; #800). Still unverified-cloudflare-static until health.json commit provenance and current-head Cloudflare acceptance are observed. GitHub Pages remains a presentation/export fallback. Runtime execution and traffic authority remain independently gated.
          </p>
          <p>
        ...
        <aside className="cockpit-panel tone-neutral" aria-label="Edge convergence truth planes">
          ...
          <dl>
            ...
            <div><dt>Candidate republish</dt><dd>exact-main SHA dispatch #800 · still unverified-cloudflare-static</dd></div>

...
type ArgumentType = string | Buffer | number | (string | Buffer | number | any[])[];
...
interface ChainableCommander<Mapping extends "resp2" | "resp3" = "resp2"> extends RedisCommander<{
  type: "pipeline";
  mapping: Mapping;
}> {
  length: number;
...
type ClusterNodeRetryStrategy = RetryStrategy;
...
interface ClusterOptions extends CommanderOptions {
  ...
  redisOptions?: Omit<RedisOptions, "enableOfflineQueue" | "himportFieldsets" | "host" | "path" | "port" | "readOnly" | "retryStrategy" | "sentinels"> | undefined;
...
type ClusterOptionsWithReplyMapping<Mapping extends ReplyMappingMode> = ClusterOptions & {
...
type NatMapFunction = (key: string) => {
  host: string;
  port: number;
} | null;
...
type ReconnectOnError = (err: Error) => boolean | 1 | 2;
...
interface RedisCommander<Context extends ClientContext = {
  ...
  bzpopmax(...args: [
    ...keys: (RedisKey)[],
    timeout: number | string,
    callback: Callback<RespShape<Resp2<[
      key: string,
      member: string,
      score: string
    ] | null>, Resp3<[
      key: string,
      member: string,
      score: Resp3Double<string>
    ] | null>, Context>>
  ]): Result<RespShape<Resp2<[
    key: string,
    member: string,
    score: string
  ] | null>, Resp3<[
  ...
  cluster(...args: [
    subcommand: 'SYNCSLOTS',
    syncToken: 'SYNC',
    taskId: string | Buffer | number,
    ...slotRanges: (string | number)[],
    callback: Callback<[
      startSlotRange: number,
      endSlotRange: number,
      ...nodes: [
  ...
  cluster(subcommand: 'SYNCSLOTS', taskIdToken: 'RDBCHANNEL', taskId: string | Buffer | number, callback?: Callback<[
    startSlotRange: number,
    endSlotRange: number,
    ...nodes: [
      host: string,
  ...
  cluster(subcommand: 'SYNCSLOTS', snapshotEof: 'SNAPSHOT-EOF', callback?: Callback<[
    startSlotRange: number,
    endSlotRange: number,
    ...nodes: [
      host: string,
  ...
  cluster(subcommand: 'SYNCSLOTS', streamEof: 'STREAM-EOF', callback?: Callback<[
    startSlotRange: number,
    endSlotRange: number,
    ...nodes: [
      host: string,
  ...
  cluster(subcommand: 'SYNCSLOTS', ackToken: 'ACK', state: string | Buffer, offset: number | string, callback?: Callback<[
    startSlotRange: number,
    endSlotRange: number,
    ...nodes: [
      host: string,
  ...
  cluster(subcommand: 'SYNCSLOTS', errorToken: 'FAIL', error: string | Buffer, callback?: Callback<[
    startSlotRange: number,
    endSlotRange: number,
    ...nodes: [
      host: string,
  ...
  config(...args: [
    ...
    callback: Callback<RespShape<Resp2<string[]>, Resp3<Resp3Map<string>>, Context>>
  ]): Result<RespShape<Resp2<string[]>, Resp3<Resp3Map<string>>, Context>, Context>;
  configBuffer(...args: [
    subcommand: 'GET',
    ...parameters: (string | Buffer)[],
    callback: Callback<RespShape<Resp2<Buffer[]>, Resp3<Resp3Map<Buffer>>, Context>>
  ]): Result<RespShape<Resp2<Buffer[]>, Resp3<Resp3Map<Buffer>>, Context>, Context>;
  config(...args: [
    subcommand: 'GET',
    ...parameters: (string | Buffer)[]
  ]): Result<RespShape<Resp2<string[]>, Resp3<Resp3Map<string>>, Context>, Context>;
  ...
  geopos(key: RedisKey, callback?: Callback<RespShape<Resp2<([
    longitude: string,
    latitude: string
  ] | null)[]>, Resp3<([
    longitude: Resp3Double<string>,
    latitude: Resp3Double<string>
  ] | null)[]>, Context>>): Result<RespShape<Resp2<([
    longitude: string,
    latitude: string
  ] | null)[]>, Resp3<([
    longitude: Resp3Double<string>,
  ...
  hscan(key: RedisKey, cursor: number | string, patternToken: 'MATCH', pattern: string, countToken: 'COUNT', count: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: string,
    elements: string[]
  ]>): Result<[
    cursor: string,
  ...
  hscanBuffer(key: RedisKey, cursor: number | string, patternToken: 'MATCH', pattern: string, countToken: 'COUNT', count: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: Buffer,
    elements: Buffer[]
  ]>): Result<[
    cursor: Buffer,
  ...
  hscan(key: RedisKey, cursor: number | string, countToken: 'COUNT', count: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: string,
    elements: string[]
  ]>): Result<[
    cursor: string,
  ...
  hscanBuffer(key: RedisKey, cursor: number | string, countToken: 'COUNT', count: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: Buffer,
    elements: Buffer[]
  ]>): Result<[
    cursor: Buffer,
  ...
  hscan(key: RedisKey, cursor: number | string, patternToken: 'MATCH', pattern: string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: string,
    elements: string[]
  ]>): Result<[
    cursor: string,
  ...
  hscanBuffer(key: RedisKey, cursor: number | string, patternToken: 'MATCH', pattern: string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: Buffer,
    elements: Buffer[]
  ]>): Result<[
    cursor: Buffer,
  ...
  hscan(key: RedisKey, cursor: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: string,
    elements: string[]
  ]>): Result<[
    cursor: string,
  ...
  hscanBuffer(key: RedisKey, cursor: number | string, novalues: 'NOVALUES', callback?: Callback<[
    cursor: Buffer,
    elements: Buffer[]
  ]>): Result<[
    cursor: Buffer,
  ...
  sort(...args: [
    ...
    asc: 'ASC',
    alpha: 'ALPHA',
    destinationToken: 'STORE',
    destination: RedisKey,
    callback: Callback<number | unknown[]>
  ]): Result<number | unknown[], Context>;
  sort(...args: [
    key: RedisKey,
    byPatternToken: 'BY',
    byPattern: string,
  ...
  vadd(...args: [
    key: RedisKey,
    ...args: (RedisValue)[],
    callback: Callback<RespShape<Resp2<number>, Resp3<boolean>, Context>>
  ]): Result<RespShape<Resp2<number>, Resp3<boolean>, Context>, Context>;
  vadd(...args: [
    key: RedisKey,
    ...args: (RedisValue)[]
  ]): Result<RespShape<Resp2<number>, Resp3<boolean>, Context>, Context>;
  ...
  vsim<T extends RedisValue[]>(...args: [
    key: RedisKey,
    ...args: T,
    callback: Callback<VsimReply<T, string, Context>>
  ]): Result<VsimReply<T, string, Context>, Context>;
  vsimBuffer<T extends RedisValue[]>(...args: [
    key: RedisKey,
    ...args: T,
    callback: Callback<VsimReply<T, Buffer, Context>>
  ]): Result<VsimReply<T, Buffer, Context>, Context>;
  vsim<T extends RedisValue[]>(...args: [
    key: RedisKey,
    ...args: T
  ]): Result<VsimReply<T, string, Context>, Context>;
  ...
  xread(...args: [
    countToken: 'COUNT',
    count: number | string,
    maxcountToken: 'MAXCOUNT',
    maxcount: number | string,
    maxsizeToken: 'MAXSIZE',
  ...
  zadd(...args: [
    ...
    incr: 'INCR',
    ...data: (string | Buffer | number)[],
    callback: Callback<RespShape<Resp2<string | null>, Resp3<Resp3Double<string> | null>, Context>>
  ]): Result<RespShape<Resp2<string | null>, Resp3<Resp3Double<string> | null>, Context>, Context>;
  zaddBuffer(...args: [
    key: RedisKey,
    nx: 'NX',
    gt: 'GT',
    ...
    incr: 'INCR',
    ...data: (string | Buffer | number)[],
    callback: Callback<RespShape<Resp2<Buffer | null>, Resp3<Resp3Double<Buffer> | null>, Context>>
  ]): Result<RespShape<Resp2<Buffer | null>, Resp3<Resp3Double<Buffer> | null>, Context>, Context>;
  zadd(...args: [
    key: RedisKey,
    nx: 'NX',
    gt: 'GT',
  ...
  zadd(...args: [
    ...
    incr: 'INCR',
    ...data: (string | Buffer | number)[],
    callback: Callback<RespShape<Resp2<string>, Resp3<Resp3Double<string>>, Context>>
  ]): Result<RespShape<Resp2<string>, Resp3<Resp3Double<string>>, Context>, Context>;
  zaddBuffer(...args: [
    key: RedisKey,
    gt: 'GT',
    ch: 'CH',
    incr: 'INCR',
    ...data: (string | Buffer | number)[],
    callback: Callback<RespShape<Resp2<Buffer>, Resp3<Resp3Double<Buffer>>, Context>>
  ]): Result<RespShape<Resp2<Buffer>, Resp3<Resp3Double<Buffer>>, Context>, Context>;
  zadd(...args: [
    key: RedisKey,
    gt: 'GT',
    ch: 'CH',
  ...
  zdiff(...args: [
    ...
    callback: Callback<RespShape<Resp2<string[]>, Resp3<[
      member: string,
      score: Resp3Double<string>
    ][]>, Context>>
  ]): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>, Context>;
  zdiffBuffer(...args: [
    ...
    ...keys: (RedisKey)[],
    withscores: 'WITHSCORES',
    callback: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
      member: Buffer,
      score: Resp3Double<Buffer>
    ][]>, Context>>
  ]): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>, Context>;
  zdiff(...args: [
  ...
  zpopmax(key: RedisKey, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ] | [
  ]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ] | [
  ]>, Context>, Context>;
  zpopmaxBuffer(key: RedisKey, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ] | [
  ]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ] | [
  ]>, Context>, Context>;
  zpopmax(key: RedisKey, count: number | string, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zpopmaxBuffer(key: RedisKey, count: number | string, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zpopmin(key: RedisKey, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ] | [
  ]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
  ...
  zpopminBuffer(key: RedisKey, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ] | [
  ]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
  ...
  zpopmin(key: RedisKey, count: number | string, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zpopminBuffer(key: RedisKey, count: number | string, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrandmember(key: RedisKey, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrandmemberBuffer(key: RedisKey, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrangebyscore(key: RedisKey, min: number | string, max: number | string, withscores: 'WITHSCORES', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangebyscoreBuffer(key: RedisKey, min: number | string, max: number | string, withscores: 'WITHSCORES', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrangebyscore(key: RedisKey, min: number | string, max: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrangebyscoreBuffer(key: RedisKey, min: number | string, max: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrank(key: RedisKey, member: string | Buffer | number, withscore: 'WITHSCORE', callback?: Callback<RespShape<Resp2<[
    rank: number,
    score: string
  ] | null>, Resp3<[
    rank: number,
  ...
  zrankBuffer(key: RedisKey, member: string | Buffer | number, withscore: 'WITHSCORE', callback?: Callback<RespShape<Resp2<[
    rank: number,
    score: Buffer
  ] | null>, Resp3<[
    rank: number,
  ...
  zrevrange(key: RedisKey, start: number | string, stop: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrevrangeBuffer(key: RedisKey, start: number | string, stop: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrevrangebyscore(key: RedisKey, max: number | string, min: number | string, withscores: 'WITHSCORES', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrevrangebyscoreBuffer(key: RedisKey, max: number | string, min: number | string, withscores: 'WITHSCORES', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrevrangebyscore(key: RedisKey, max: number | string, min: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[
    member: string,
    score: Resp3Double<string>
  ][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[
    member: string,
  ...
  zrevrangebyscoreBuffer(key: RedisKey, max: number | string, min: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
    score: Resp3Double<Buffer>
  ][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[
    member: Buffer,
  ...
  zrevrank(key: RedisKey, member: string | Buffer | number, withscore: 'WITHSCORE', callback?: Callback<RespShape<Resp2<[
    rank: number,
    score: string
  ] | null>, Resp3<[
    rank: number,
  ...
  zrevrankBuffer(key: RedisKey, member: string | Buffer | number, withscore: 'WITHSCORE', callback?: Callback<RespShape<Resp2<[
    rank: number,
    score: Buffer
  ] | null>, Resp3<[
    rank: number,
...
type RedisStatus = "close" | "connect" | "connecting" | "end" | "ready" | "reconnecting" | "wait";
...
type ReplyMappingFromClusterOptions<Current extends ReplyMappingMode, Options> = Options extends {
  redisOptions: {
...
type ReplyMappingFromOptions<Current extends ReplyMappingMode, Options> = Options extends {
  replyMapping: infer Mapping;
} ? Extract<Mapping, ReplyMappingMode> extends never ? Current : Extract<Mapping, ReplyMappingMode> : Current;

type ReplyMappingMode = "legacy" | "resp3";

type ReplyTransformer = (reply: any, context: ReplyTransformerContext) => any;

interface ReplyTransformerContext {
  commandName: string;
  protocol: ProtocolVersion;
  replyMapping: ReplyMappingMode;
}
...
type Resp3Double<ReplyString extends string | Buffer = string> = number;

type Resp3Map<Value> = Record<string, Value>;

type RespShape<Resp2Result extends Resp2<unknown>, Resp3Result extends Resp3<unknown>, Context extends ClientContext> = Context extends {
  mapping: "resp3";
...
interface Transaction<Mapping extends "resp2" | "resp3" = "resp2"> {
...
type VsimReply<T extends RedisValue[], V extends string | Buffer, Context extends ClientContext> = Extract<T[number], "WITHATTRIBS"> extends never ? Extract<T[number], "WITHSCORES"> extends never ? V[] : RespShape<Resp2<V[]>, Resp3<Resp3Map<Resp3Double<V>>>, Context> : Extract<T[number], "WITHSCORES"> extends never ? RespShape<Resp2<V[]>, Resp3<Resp3Map<V | null>>, Context> : RespShape<Resp2<V[]>, Resp3<Resp3Map<[
  score: Resp3Double<V>,
  attributes: V | null
]>>, Context>;
